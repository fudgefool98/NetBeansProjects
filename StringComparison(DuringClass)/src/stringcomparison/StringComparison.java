...
public class StringComparison {
    ...
    /**
     * @notes 
     *  the point of this code is to prove that even two string objects that
     * have the same value could not be equivalent using the '==' in some cases
     */
    public static void main(String[] args) {
        ...
        if(name == name) System.out.println("They are equal!");
        else System.out.println("They are not equal!");

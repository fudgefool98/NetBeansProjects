...
public class FXMLDocumentController implements Initializable {
    ...
    public void ready(Stage stage) {
        ...
        1 top most UI object, so key presses from anywhere in UI will work
        2 if no elements in the UI that normally get key presses then 
        putting the listener on a UI container other than stage
        will not work.

...
//the other way to create a thread, implement the Runnable interface.
//this is the recommended way since we can extend another class or implement other interfaces
